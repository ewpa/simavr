...
{
	elf_firmware_t f;
	const char * fname = "atmega168_stdiodemo.axf";
//	char path[256];
...
//	printf("Firmware pathname is %s\n", path);
	...
	strncpy(uart.dev, "/tmp/pts-1", 20);
	uart_ttyusb_init(avr, &uart);
	uart_ttyusb_connect(&uart, '0');
	...
	printf( "Demo : This is UART and HD44780 LCD demo\n"
